...
/*
    ...
    Función que reproduce el vídeo de fondo al hacer scroll, y detiene la reproducción al detener el scroll
*/
...
//Función para agregar y renderizar los resultados en la página
...
//Simular llamada a base de datos en buscador.php con AJAX y método GET. No se tienen datos sensibles
    $.get('logica.php', {ciudad:ciudad, tipo:tipo, precio:precio}, function(response){
